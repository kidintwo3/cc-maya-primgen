...
def setPrimgen(node):
    if node:
        if len(node) == 2:
            ...
            #cmds.setAttr(node[0] + ".autoSegments", True)
            #cmds.setAttr(node[0] + ".autoSegmentsMultiplier", 1)
            ...
            # UV
            cmds.setAttr(node[0] + ".uOffset", 0.7)
            cmds.setAttr(node[0] + ".vOffset", 1.0)
            
            cmds.setAttr(node[0] + ".uWidth", 0.7)
            cmds.setAttr(node[0] + ".vWidth", 0.65)
